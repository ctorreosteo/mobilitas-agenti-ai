---
description: Fa girare tutti i cancelli deterministici su una pratica — protezioni, atto, conservazione
argument-hint: "[pratica]"
---

Fai girare tutto ciò che si può verificare contando, prima di guardare l'atto con gli occhi.

**L'ordine non è casuale.** Se le protezioni non funzionano, tutto il resto è un'opinione: si
collaudano per prime.
...
## 3. La conservazione lungo la catena
...
Riporta, in questo ordine: **protezioni** (quanti casi, quanti falliti), **atto** (bloccanti e
avvisi, con il testo di ciascuno), **conservazione** (i numeri dei due passaggi), **disco** (quali
file esistono davvero), **scadenze** (il primo termine in ordine di data).
