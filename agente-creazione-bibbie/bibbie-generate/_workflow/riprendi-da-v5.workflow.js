export const meta = {
  name: 'riprendi-bibbie-da-v5',
  description: 'RIPRESA di una Bibbia gia arrivata alla revisione di 4o livello: riparte dalla Sintesi v5 (applica la mappa di taglio dell editor alla v4) e prosegue con riscrittura di chiarezza -> v6, revisione di lingua -> v7 finale, COLLAUDO DI CONSERVAZIONE con riparazione mirata. Presuppone che v4-intermedia.md, mappa-v4.md e i feedback-*-r4.md esistano gia',
  whenToUse: 'Quando una Bibbia si e fermata dopo la revisione di 4o livello e va portata alla consegna senza rifare i livelli 1-4',
  phases: [
...
const results = await pipeline(
  ...
  // --- STAGE 1 (RIPRESA): SINTESI v5 ---
  // I livelli 1-4 sono gia girati in una sessione precedente: v4-intermedia.md, mappa-v4.md
  // e i feedback-*-r4.md esistono gia sul disco. Qui si riparte dalla sintesi che applica
  // la mappa di taglio dell'editor. Non si rifa nessuna revisione.
  async (slug) => {
