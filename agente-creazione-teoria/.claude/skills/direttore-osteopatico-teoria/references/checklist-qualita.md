...
Passa ogni punto prima di consegnare. Un solo NO = si corregge, non si consegna con una nota. **Prima della checklist assegna il punteggio della rubrica** (`rubrica-punteggio.md`): sotto 90/100 non si arriva nemmeno qui.
...
- [ ] **Nessuna frase sopra le 35 parole.** Controllale, non fidarti.
- [ ] Nessuna subordinata dentro una subordinata. Nessun inciso dentro un inciso.
- [ ] Nessun capoverso sopra le 4 frasi.
...
- [ ] **Mappa concettuale** generata: una pagina, sei blocchi, tutto estratto dalla Bibbia.
- [ ] Nessuna informazione della Mappa è assente dalla Bibbia.
- [ ] Voce per l'indice maestro pronta (o segnalato che va aggiornato).
- [ ] Bibbia e Mappa presentate **insieme**.

## Voce

- [ ] "Tu" all'osteopata ovunque. Zero "si consiglia di", zero "l'operatore".
- [ ] Voce attiva. Le tre voci (spiega / direttore / motiva) presenti, con la motivazionale usata **due o tre volte in tutto**.
- [ ] Metafore nuove, non riciclate da un'altra Bibbia. Una per meccanismo.
- [ ] Non più di due grassetti per capoverso.
- [ ] Zero emoji, zero "in conclusione", zero meta-commenti sul documento stesso.
- [ ] Il ragionamento unico Mobilitas è argomentato sulla condizione **come cornice clinica, non come prova**.

## Compliance

- [ ] Nessuna promessa di esito clinico.
- [ ] Nessun "cura", "risolve definitivamente", "elimina".
- [ ] Nessun invito a sospendere o modificare farmaci, nemmeno in forma dubitativa.
- [ ] Nessuna denigrazione di colleghi o categorie.
- [ ] Linguaggio coerente con lo status di professione sanitaria (DPCM 2026) e con il DPR 131/2021.

## File

- [ ] `.docx` generato, renderizzato e **guardato**: tabelle integre, heading corretti, nessun carattere rotto.
- [ ] Salvato in `outputs/<slug>/` e presentato.
